...
async def create_openai_chat_client() -> Union[openai.AsyncAzureOpenAI, openai.AsyncOpenAI]:
    openai_chat_client: Union[openai.AsyncAzureOpenAI, openai.AsyncOpenAI]
    OPENAI_CHAT_HOST = os.getenv("OPENAI_CHAT_HOST")
    if OPENAI_CHAT_HOST == "azure":
        api_version = os.environ.get("AZURE_OPENAI_VERSION") or "2024-10-21"
        ...
        if api_key := os.getenv("AZURE_OPENAI_KEY"):
            ...
            raise ValueError("Azure OpenAI client requires an API key (AZURE_OPENAI_KEY).")
...
async def create_openai_embed_client() -> Union[openai.AsyncAzureOpenAI, openai.AsyncOpenAI]:
    openai_embed_client: Union[openai.AsyncAzureOpenAI, openai.AsyncOpenAI]
    OPENAI_EMBED_HOST = os.getenv("OPENAI_EMBED_HOST")
    if OPENAI_EMBED_HOST == "azure":
        api_version = os.environ.get("AZURE_OPENAI_VERSION") or "2024-03-01-preview"
        azure_endpoint = os.environ["AZURE_OPENAI_ENDPOINT"]
